const Sedes = ()=>{
    ...
    <div className="contenedor1">
        <h1 className="titulo titulo-principalrs">Nuestras sedes</h1>

        <p> Nuestro proyecto de crecimiento y expansion nos permite estar presente en dos territorios claves para referenciarnos como un aliado clave de las personas altamente productivas y concientes de Antioquia</p>
    </div>
